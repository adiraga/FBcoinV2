...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("FBcoin");
    QApplication::setOrganizationDomain("xfbcoin.com");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("FBcoin-Qt-testnet");
    else
        QApplication::setApplicationName("FBcoin-Qt");
